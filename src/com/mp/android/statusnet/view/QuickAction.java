package com.mp.android.statusnet.view;
...
public class QuickAction extends CustomPopupWindow {
	...
	public void show () {
		...
		//test by xiaosong
		Log.v("xiaosong","onTop---"+onTop);
		Log.v("xiaosong","rootHeight---"+rootHeight);
		Log.v("xiaosong","dyTop---"+dyTop);
		Log.v("xiaosong","dyBottom---"+dyBottom);
...
//		}
		...
		window.showAtLocation(anchor, Gravity.NO_GRAVITY, xPos, yPos-30);
	}
	...
	private View getActionItem(String title, Drawable icon, OnClickListener listener) {
		...
		if (title != null) {
			//add by xiaosong
			//text.setTextColor(R.color.galy);
			//end by xiaosong
			text.setText(title);
		}
