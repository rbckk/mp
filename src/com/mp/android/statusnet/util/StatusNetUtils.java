...
public class StatusNetUtils {
	...
	public static final Linkify.MatchFilter NAME_MATCHER_MATCH_FILTER = new Linkify.MatchFilter() {
	...
	public static final Linkify.MatchFilter TAG_MATCHER_MATCH_FILTER = new Linkify.MatchFilter() {
		public final boolean acceptMatch(final CharSequence s, final int start,final int end) {
			if (start == 0) {
				return false;
			}
	...
	public static final Linkify.MatchFilter GROUP_MATCHER_MATCH_FILTER = new Linkify.MatchFilter() {
