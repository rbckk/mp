...
public class NewsFeedPublish extends Activity {
	...
	private void setListener() {
		...
		mPublish.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mContent.getText().toString().trim().length() == 0) {
					Toast.makeText(NewsFeedPublish.this, getString(R.string.input_null),
		...
		mPlace.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mPlace.getText().toString().equals(getString(R.string.add_location))) {
					mLBSIsReceiver = true;
					mPlace.setText(getString(R.string.locationing));
					...
					mClient.requestLocation();
				} else if (mPlace.getText().toString().equals(getString(R.string.locationing))) {
					if (mClient.isStarted()) {
						mClient.stop();
						mLBSIsReceiver = false;
						mLBSAddress = null;
						mPlace.setCompoundDrawables(mPoi_off_icon, null, null, null);
						mPlace.setText(getString(R.string.add_location));
		...
		mVoice.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Toast.makeText(NewsFeedPublish.this, getString(R.string.no_function),
						Toast.LENGTH_SHORT).show();
			}
		});
...
//		mApplication.mAsyncRenRen.publishNewsFeed(param, listener);
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				case 1:
					mContent.setText("");
					Toast.makeText(NewsFeedPublish.this,getString(R.string.publish_ok),
							Toast.LENGTH_SHORT).show();
					finish();
					overridePendingTransition(0, R.anim.roll_down);
					break;
				...
				case 10400:
					Toast.makeText(NewsFeedPublish.this,getString(R.string.publish_too_more),
							Toast.LENGTH_SHORT).show();
					break;
				case 10401:
					Toast.makeText(NewsFeedPublish.this, getString(R.string.publish_too_long),
							Toast.LENGTH_SHORT).show();
					break;

				case 10402:
					Toast.makeText(NewsFeedPublish.this, getString(R.string.publish_illegal),
							Toast.LENGTH_SHORT).show();
					break;
				}
				break;
	...
	private void backDialog() {
		...
		builder.setMessage(getString(R.string.publish_cancel));
	...
	private void publishDialogShow() {
		if (mPublishDialog == null) {
			...
			mPublishDialog.setMessage(getString(R.string.publishing));
		}
		mPublishDialog.show();
	}
